...
function runAcceptance(): void {
  ...
  for (const code of protectedCodes) if (!COMMUNITY_RUNTIME_BLOCKERS.some(blocker => blocker.code === code)) failures.push(`Source-gap removed without authority: ${code}`);
