...
import { OFFICIAL_DARKEST_DUNGEON_QUESTS, isDarkestDungeonOfficialQuestPoolEnabled } from '../../data/darkest-dungeon/quest-registry';
import { OFFICIAL_GUARDIAN_ASSEMBLY, isAllGuardianFamiliesReady } from '../../data/darkest-dungeon/official-guardian-assembly';
import { FINAL_FORM_ORDER, OFFICIAL_FINAL_FORMS, UNSKIPPABLE_FINAL_FORM_ID, isFinalEncounterOfficialEnabled } from '../../data/darkest-dungeon/final-form-registry';
...
export function createProductionOfficialMatrixRunner(): OfficialMatrixRunner | undefined {
  if (!isAllGuardianFamiliesReady() || !isDarkestDungeonOfficialQuestPoolEnabled() || !isFinalEncounterOfficialEnabled()) return undefined;
  return { runCombination(family: GuardianFamily, skippedFormId: SkippedFormId, mode: 'formal') {
