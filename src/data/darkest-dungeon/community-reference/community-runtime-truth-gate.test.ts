...
describe('Community Runtime Acceptance Truth Gate adversarial mutations', () => {
  ...
  it('T05 runtime Final Form d10 map mutation fails', () => { const env = cloneEnvironment(); env.ancestorFirst.vacantStanceD10Map![1] = 'imperfect'; expect(mismatch(env)).toContain('runtime semantic mismatch tierB-ancestor-first-form.vacantStanceFillSource'); });
